...
<head>
    ...
    <!-- 页面样式 -->
    <link rel="stylesheet" href="http://localhost:9000/game-fun/app/plugins/css/index.css">
</head>
...
<script src="http://localhost:9000/game-fun/app/plugins/js/axios.min.js"></script>
<!-- 页面逻辑 -->
<script src="http://localhost:9000/game-fun/app/plugins/js/index.js"></script>
</body>
